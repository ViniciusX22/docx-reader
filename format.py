...
ap.add_argument("-d", '--document', default='test.docx',
...
ap.add_argument('-c', '--cover-values', default='',
                help="File with values for cover template")
ap.add_argument('--gui', action='store_true', help="Get input using a GUI")


def add_cover_template(doc, values):
    template = Document('cover-template.docx')
